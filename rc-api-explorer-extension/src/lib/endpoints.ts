...
export const ENDPOINTS: Endpoint[] = [
  ...
  { id:'pcm-1', category:'PCM', name:'Bulk Product Details', methods:['POST'],
    path:'/connect/pcm/products/bulk', version:'v66.0',
  ...
  { id:'pcm-4', category:'PCM', name:'Products List', methods:['POST'],
    path:'/connect/pcm/products', version:'v61.0',
  ...
  { id:'pcm-17', category:'PCM', name:'Index Configuration Collection', methods:['GET','PUT'],
    ...
    response:'{\n  "correlationId": "index-cfg-001",\n  "indexConfigurations": [\n    {"fieldApiName": "Name","fieldType": "STANDARD","isEnabled": true},\n    {"fieldApiName": "ProductCode","fieldType": "STANDARD","isEnabled": true}\n  ],\n  "status": {"code": "200","message": "Index configurations updated successfully."}\n}' },
  ...
  { id:'pcm-18', category:'PCM', name:'Index Setting', methods:['GET','PATCH'],
    ...
    page:158,
    params:[
      {name:'settingId',type:'String',req:true,location:'query',desc:'(v63.0) (PATCH) ID of the setting to update. Required for PATCH.'},
      {name:'setting',type:'Setting Input[]',req:true,location:'body',desc:'(v63.0) (PATCH) Object containing setting details. Required for PATCH.'},
    ],
    request:'GET: No request body.\n\nPATCH body (with ?settingId=0axxx0000000001AAA query param):\n{\n  "setting": [\n    {"name": "searchableFields","value": "Name,ProductCode,Description"}\n  ]\n}',
    response:'GET: {\n  "setting": [\n    {"id": "0axxx0000000001AAA","name": "searchableFields","value": "Name,ProductCode"}\n  ],\n  "status": {"code": "200"}\n}\n\nPATCH: {\n  "setting": [\n    {"id": "0axxx0000000001AAA","name": "searchableFields","value": "Name,ProductCode,Description"}\n  ],\n  "status": {"code": "200"}\n}' },
  ...
  { id:'cfg-1', category:'Configurator', name:'Configuration', methods:['POST'],
    ...
    desc:'Initiates or updates a product configuration session.',
    page:970,
    params:[
      {name:'productId',type:'String',req:true,desc:'Product ID to configure.'},
      {name:'contextId',type:'String',req:false,desc:'Context ID.'},
      {name:'quantity',type:'Integer',req:false,desc:'Quantity.'},
    ],
    request:'{\n  "productId": "01txx0000000001AAA",\n  "quantity": 1\n}',
    response:'{\n  "configurationId": "0YESa00000001AAAA",\n  "productId": "01tSa00000AzpIaIAJ",\n  "status": "InProgress",\n  "quantity": 1,\n  "attributes": [\n    {"name": "Subscription Term","value": "36","dataType": "Picklist"},\n    {"name": "Vehicle Type","value": null,"dataType": "Picklist","isRequired": true}\n  ],\n  "violations": []\n}' },
  ...
  { id:'cfg-2', category:'Configurator', name:'Saved Configuration', methods:['GET','POST'],
    ...
    desc:'GET retrieves saved configurations. POST creates a new one.',
    page:971,
    params:[
      {name:'name',type:'String',req:true,desc:'(POST) Configuration name.'},
      {name:'productId',type:'String',req:true,desc:'(POST) Product ID.'},
    ],
    request:'{\n  "name": "My Config",\n  "productId": "01txx0000000001AAA",\n  "configurationData": {}\n}',
    response:'{\n  "id": "0YFSa00000001AAAA",\n  "name": "My Config",\n  "productId": "01tSa00000AzpIaIAJ",\n  "configurationData": {"attributes": {"Subscription Term": "36"}},\n  "createdDate": "2024-07-09T10:00:00Z",\n  "lastModifiedDate": "2024-07-09T10:00:00Z"\n}' },
  ...
  { id:'cfg-3', category:'Configurator', name:'Configurator Add Nodes', methods:['POST'],
    ...
    desc:'Adds product nodes to a configuration.',
    page:975,
    params:[
      {name:'configurationId',type:'String',req:true,desc:'Configuration ID.'},
      {name:'nodes',type:'Object[]',req:true,desc:'Nodes to add.'},
    ],
    request:'{\n  "configurationId": "0YExx0000000001AAA",\n  "nodes": [{"productId": "01txx0000000002AAA","quantity": 1}]\n}',
    response:'{\n  "configurationId": "0YESa00000001AAAA",\n  "addedNodes": ["node-001"],\n  "configuration": {\n    "status": "InProgress",\n    "nodes": [\n      {"nodeId": "node-001","productId": "01tSa00000AzpIaIAJ","quantity": 1}\n    ],\n    "violations": []\n  }\n}' },

  { id:'cfg-4', category:'Configurator', name:'Config Rules Execute', methods:['POST'],
    path:'/revenue/product-configurator/rules/actions/execute', version:'v60.0',
    desc:'Executes product configuration rules for a given context.',
    page:978,
    params:[
      {name:'configurationId',type:'String',req:true,desc:'Configuration ID.'},
      {name:'ruleIds',type:'String[]',req:false,desc:'Specific rule IDs to execute.'},
    ],
    request:'{\n  "configurationId": "0YExx0000000001AAA"\n}',
    response:'{\n  "configurationId": "0YESa00000001AAAA",\n  "rulesExecuted": 3,\n  "violations": [],\n  "attributes": [\n    {"name": "Subscription Term","value": "36","isLocked": false},\n    {"name": "Vehicle Type","value": "LCVCar","isLocked": false}\n  ],\n  "status": "Success"\n}' },
  ...
  { id:'txn-1', category:'Transaction', name:'Asset Amendment', methods:['POST'],
    ...
    desc:'Initiates and executes the amendment of a quote or order.',
    page:1383,
    params:[
      {name:'assetIds',type:'String[]',req:true,desc:'Asset IDs to amend.'},
      {name:'amendmentStartDate',type:'String',req:true,desc:'Start date of amendment.'},
      {name:'outputRecordType',type:'String',req:true,desc:'Quote or Order.'},
      {name:'quantityChange',type:'Double',req:true,desc:'Quantity change.'},
    ],
    request:'{\n  "assetIds": ["{{ASSET_ID}}"],\n  "amendmentStartDate": "2024-01-01T00:00:00",\n  "outputRecordType": "Quote",\n  "quantityChange": 5\n}',
  ...
  { id:'txn-2', category:'Transaction', name:'Asset Cancellation', methods:['POST'],
    ...
    page:1385,
    params:[
      {name:'assetIds',type:'String[]',req:true,desc:'Asset IDs to cancel.'},
      {name:'cancellationDate',type:'String',req:true,desc:'Effective cancellation date.'},
      {name:'outputRecordType',type:'String',req:true,desc:'Type of cancellation record.'},
    ],
  ...
  { id:'txn-3', category:'Transaction', name:'Asset Renewal', methods:['POST'],
    ...
    desc:'Initiates and executes the renewal of an asset.',
    page:1386,
    params:[
      {name:'assetIds',type:'String[]',req:true,desc:'Asset IDs to renew.'},
      {name:'outputRecordType',type:'String',req:true,desc:'Quote or Order.'},
    ],
    request:'{\n  "assetIds": ["{{ASSET_ID}}"],\n  "outputRecordType": "Quote",\n  "renewalEndDate": "2025-01-01T00:00:00",\n  "renewalStartDate": "2024-01-01T00:00:00"\n}',
  ...
  { id:'txn-4', category:'Transaction', name:'Place Quote', methods:['POST'],
    path:'/connect/cpq/quotes', version:'v60.0',
    desc:'Create a quote to discover and price products. Insert, update, or delete a quote line item.',
    page:1400,
    params:[
      {name:'contextId',type:'String',req:false,desc:'Context ID.'},
      {name:'records',type:'Object[]',req:true,desc:'Quote records.'},
    ],
    request:'{\n  "records": [\n    {\n      "referenceId": "ref1",\n      "record": {\n        "attributes": {"type": "Quote","method": "POST"},\n        "Name": "My Quote",\n        "Pricebook2Id": "{{PRICE_BOOK_ID}}"\n      }\n    }\n  ]\n}',
  ...
  { id:'txn-5', category:'Transaction', name:'Initiate Downgrade', methods:['POST'],
    ...
    desc:'Move to a lower-tier product. Creates amendment quote with downgrade-specific order actions.',
    page:1391,
    params:[
      {name:'swapStartDate',type:'String',req:true,desc:'Amendment start date.'},
      {name:'outputRecordType',type:'String',req:true,desc:'Quote or Order.'},
      {name:'swapGroups',type:'Swap Group[]',req:true,desc:'Asset details for downgrade.'},
    ],
  ...
  { id:'txn-6', category:'Transaction', name:'Initiate Upgrade', methods:['POST'],
    ...
    desc:'Move a lower-tier product to a higher-tier product.',
    page:1394,
    params:[
      {name:'swapStartDate',type:'String',req:true,desc:'Amendment start date.'},
      {name:'outputRecordType',type:'String',req:true,desc:'Quote or Order.'},
      {name:'swapGroups',type:'Swap Group[]',req:true,desc:'Asset details for upgrade.'},
    ],
    request:'{\n  "swapStartDate": "2025-12-01T00:00:00Z",\n  "outputRecordType": "Quote",\n  "swapGroups": {"groups": []}\n}',
  ...
  { id:'txn-8', category:'Transaction', name:'Place Order', methods:['POST'],
    path:'/services/data/v67.0/sobjects/AsyncOperationTracker', version:'v60.0',
    desc:'Create or update an order using the AsyncOperationTracker pattern.',
    page:1381,
    params:[
      {name:'graph',type:'Object',req:true,location:'body',desc:'(v60.0) sObject graph of order structure.'},
      {name:'pricingPref',type:'String',req:false,location:'body',desc:'(v60.0) Force, Skip, or System.'},
      {name:'configurationInput',type:'String',req:false,location:'body',desc:'(v60.0) RunAndAllowErrors, RunAndBlockErrors, or Skip.'},
      {name:'configurationOptions',type:'Object',req:false,location:'body',desc:'(v60.0) Config options during ingestion.'},
      {name:'catalogRatesPreference',type:'String',req:false,location:'body',desc:'(v62.0) Fetch or Skip.'},
    ],
    request:'{\n  "graph": {\n    "graphId": "PlaceOrder",\n    "records": []\n  },\n  "pricingPref": "System"\n}',
    response:'{\n  "graphs": [\n    {\n      "graphId": "PlaceOrder",\n      "isSuccessful": true,\n      "graphResponse": {\n        "compositeResponse": []\n      }\n    }\n  ]\n}' },
  ...
  { id:'txn-9', category:'Transaction', name:'Place Sales Transaction', methods:['POST'],
    path:'/services/data/v67.0/sobjects/AsyncOperationTracker', version:'v60.0',
    desc:'Create or update a sales transaction (quote or order) using AsyncOperationTracker.',
    page:1381,
    params:[
      {name:'graph',type:'Object',req:true,location:'body',desc:'(v60.0) sObject graph of the sales transaction.'},
      {name:'pricingPref',type:'String',req:false,location:'body',desc:'(v60.0) Force, Skip, or System.'},
      {name:'catalogRatesPreference',type:'String',req:false,location:'body',desc:'(v63.0) Fetch or Skip.'},
      {name:'configurationInput',type:'String',req:false,location:'body',desc:'(v60.0) RunAndAllowErrors, RunAndBlockErrors, or Skip.'},
      {name:'configurationOptions',type:'Object',req:false,location:'body',desc:'(v60.0) Config options during ingestion.'},
      {name:'taxPref',type:'String',req:false,location:'body',desc:'(v65.0) Tax calculation preference. Value: Skip.'},
      {name:'contextDetails',type:'Object',req:false,location:'body',desc:'(v63.0) Context details for the sales transaction.'},
    ...
    request:'{\n  "graph": {\n    "graphId": "PlaceSalesTxn",\n    "records": []\n  },\n  "pricingPref": "System"\n}',
    response:'{\n  "requestId": "req-001",\n  "statusURL": "/services/data/v67.0/sobjects/AsyncOperationTracker/{{REQUEST_ID}}",\n  "success": true\n}' },
  ...
  { id:'txn-12', category:'Transaction', name:'Preview Approval', methods:['POST'],
    path:'/services/data/v67.0/sobjects/AsyncOperationTracker', version:'v65.0',
    desc:'Preview the approval chain for a record without submitting for approval.',
    page:1381,
    params:[
      {name:'flowApiName',type:'String',req:true,location:'body',desc:'(v65.0) API name of the auto-launched flow.'},
      {name:'objectApiName',type:'String',req:true,location:'body',desc:'(v65.0) API name of the object to preview.'},
      {name:'recordId',type:'String',req:true,location:'body',desc:'(v65.0) Record ID to preview approvals for.'},
      {name:'inputParameters',type:'Object',req:false,location:'body',desc:'(v67.0) Input parameters for the flow.'},
    ],
  ...
  // Configurator — new canonical paths from PDF
  { id:'cfg-5', category:'Configurator', name:'Configuration Load', methods:['POST'],
    path:'/commerce/configurations/load', version:'v60.0',
    desc:'Load or initialize a product configuration session (canonical v60.0 path).',
    page:955,
    params:[
      {name:'transactionId',type:'String',req:true,location:'body',desc:'(v60.0) ID of the sales transaction being configured.'},
      {name:'correlationId',type:'String',req:false,location:'body',desc:'(v60.0) ID for traceability.'},
      {name:'contextResponseType',type:'String',req:false,location:'body',desc:'(v65.0) Response type for large txns: Delta, Full, None, or Product.'},
      {name:'qualificationContext',type:'Object',req:false,location:'body',desc:'(v60.0) User context for qualification rules.'},
    ],
    request:'{\n  "transactionId": "{{SALES_TRANSACTION_ID}}"\n}',
    response:'{\n  "contextId": "{{CONTEXT_ID}}",\n  "status": "InProgress"\n}' },

  { id:'cfg-6', category:'Configurator', name:'Configuration Set Instance', methods:['POST'],
    path:'/commerce/configurations/set', version:'v60.0',
    desc:'Set a configuration instance from a context mapping.',
    page:955,
    params:[
      {name:'contextMappingId',type:'String',req:true,location:'body',desc:'(v60.0) ID of the context mapping record.'},
      {name:'configuratorOptions',type:'Object',req:false,location:'body',desc:'(v60.0) Options to pass to the configurator.'},
      {name:'qualificationContext',type:'Object',req:false,location:'body',desc:'(v60.0) Context for qualification rules.'},
      {name:'transaction',type:'String',req:false,location:'body',desc:'(v60.0) Transaction JSON payload as string.'},
    ],
    request:'{\n  "contextMappingId": "{{CONTEXT_MAPPING_ID}}"\n}',
    response:'{\n  "contextId": "{{CONTEXT_ID}}",\n  "status": "InProgress"\n}' },

  { id:'cfg-7', category:'Configurator', name:'Configurator Delete Nodes', methods:['POST'],
    path:'/commerce/configurations/delete-nodes', version:'v60.0',
    desc:'Delete product nodes from a configuration context.',
    page:955,
    params:[
      {name:'contextId',type:'String',req:true,location:'body',desc:'(v60.0) ID of the context object.'},
      {name:'deletedNodes',type:'Object[]',req:true,location:'body',desc:'(v60.0) Nodes to delete.'},
      {name:'configuratorOptions',type:'Object',req:false,location:'body',desc:'(v60.0) Execution options.'},
      {name:'qualificationContext',type:'Object',req:false,location:'body',desc:'(v60.0) Qualification context.'},
    ],
    request:'{\n  "contextId": "{{CONTEXT_ID}}",\n  "deletedNodes": []\n}',
    response:'{\n  "contextId": "{{CONTEXT_ID}}",\n  "success": true\n}' },

  { id:'cfg-8', category:'Configurator', name:'Configurator Update Nodes', methods:['POST'],
    path:'/commerce/configurations/update-nodes', version:'v60.0',
    desc:'Update product nodes in a configuration context.',
    page:955,
    params:[
      {name:'contextId',type:'String',req:true,location:'body',desc:'(v60.0) ID of the context object.'},
      {name:'updatedNodes',type:'Object[]',req:true,location:'body',desc:'(v60.0) Nodes to update.'},
      {name:'configuratorOptions',type:'Object',req:false,location:'body',desc:'(v60.0) Execution options.'},
      {name:'qualificationContext',type:'Object',req:false,location:'body',desc:'(v60.0) Qualification context.'},
    ],
    request:'{\n  "contextId": "{{CONTEXT_ID}}",\n  "updatedNodes": []\n}',
  ...
  { id:'cfg-9', category:'Configurator', name:'Configuration Save', methods:['POST'],
    path:'/commerce/configurations/save', version:'v63.0',
    desc:'Save a named configuration for a reference record.',
    page:955,
    params:[
      {name:'referenceRecordId',type:'String',req:true,location:'body',desc:'(v63.0) ID of the record to save configuration for.'},
      {name:'data',type:'String',req:false,location:'body',desc:'(v63.0) JSON sales transaction as string.'},
      {name:'description',type:'String',req:false,location:'body',desc:'(v63.0) Description of the saved config.'},
      {name:'name',type:'String',req:false,location:'body',desc:'(v63.0) Name of the saved config.'},
    ],
    request:'{\n  "referenceRecordId": "{{QUOTE_ID}}",\n  "name": "My Saved Config"\n}',
    response:'{\n  "id": "{{CONFIG_ID}}",\n  "name": "My Saved Config",\n  "success": true\n}' },

  { id:'cfg-10', category:'Configurator', name:'Configuration Save Instance', methods:['POST'],
    path:'/commerce/configurations/save-instance', version:'v60.0',
    desc:'Save an active configuration context instance.',
    page:955,
    params:[
      {name:'contextId',type:'String',req:true,location:'body',desc:'(v60.0) Transaction context ID to save.'},
    ],
    request:'{\n  "contextId": "{{CONTEXT_ID}}"\n}',
    response:'{\n  "id": "{{CONFIG_INSTANCE_ID}}",\n  "success": true\n}' },

  { id:'cfg-11', category:'Configurator', name:'Configuration List', methods:['GET'],
    path:'/commerce/configurations', version:'v63.0',
    desc:'List saved configurations for a reference record.',
    page:955,
    params:[
      {name:'referenceRecordId',type:'String',req:true,location:'query',desc:'(v63.0) Filter saved configurations by record ID.'},
    ],
    request:'No request body.',
    response:'{\n  "configurations": []\n}' },

  { id:'cfg-12', category:'Configurator', name:'Configuration Get Instance', methods:['GET'],
    path:'/commerce/configurations/{configId}', version:'v60.0',
    desc:'Get a saved configuration instance by ID.',
    page:955,
    params:[
      {name:'configId',type:'String',req:true,location:'path',desc:'(v60.0) Configuration ID.'},
    ],
    request:'No request body.',
    response:'{\n  "id": "{{CONFIG_ID}}",\n  "referenceRecordId": "{{QUOTE_ID}}",\n  "data": "{}"\n}' },

  { id:'cfg-13', category:'Configurator', name:'Product Quantity Set', methods:['POST'],
    path:'/commerce/configurations/set-quantity', version:'v60.0',
    desc:'Set quantity for a product in a configuration context.',
    page:955,
    params:[
      {name:'contextId',type:'String',req:true,location:'body',desc:'(v60.0) Context object ID.'},
      {name:'quantity',type:'Integer',req:true,location:'body',desc:'(v60.0) Product quantity value.'},
      {name:'transactionLinePath',type:'String[]',req:true,location:'body',desc:'(v60.0) Path to the line item to update.'},
      {name:'configuratorOptions',type:'Object',req:false,location:'body',desc:'(v60.0) Execution options.'},
      {name:'qualificationContext',type:'Object',req:false,location:'body',desc:'(v60.0) Qualification context.'},
    ],
    request:'{\n  "contextId": "{{CONTEXT_ID}}",\n  "quantity": 2,\n  "transactionLinePath": ["{{LINE_ITEM_ID}}"]\n}',
    response:'{\n  "contextId": "{{CONTEXT_ID}}",\n  "success": true\n}' },
